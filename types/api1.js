...
function calculateCarValue(input) {
    ...
    var model = input.model, year = input.year; //destructuring to extract model & year properties from input object and store them as separate variables.
    ...
    var sum = sanitizedModel
        ...
        .reduce(function (total, char) { return total + char.charCodeAt(0) - 64; }, 0); // Calculate the sum of character positions - A=1 B=2 etc
...
var resultCarValue = calculateCarValue(inputData);
